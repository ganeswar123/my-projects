...
<h2>Add Student</h2>
<s:form action="addStudentAction" namespace="/">
  <s:textfield name="firstName" label="FirstName" value="" />
  <s:textfield name="middleName" label="MiddleName" value="" />
  <s:textfield name="lastName" label="LastName" value="" />
  <s:textfield name="email" label="Email" value="" />
  <s:textfield name="phone" label="Phone" value="" />
  <s:date name="joinDate" id="joinDate" var="joinDate" />
   <s:submit />
</s:form>
