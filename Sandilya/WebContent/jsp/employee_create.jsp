...
<s:form action="addEmployeeAction" name="form:%{count}"
	id="form:%{count}">
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
			...
			<tr>
				...
				<td><input type="text" id="defaultcurrency"
					...
					maxlength="30" tabindex="2" class="mainContentsText"
			...
			<tr>
				...
				<td><input class="mainContentsText" type="text"
					...
					id="defaultlanguage" width="100%" maxlength="20" tabindex="3"
					onclick="onFocusAction(this.id);"
					onkeydown="onFocusAction(this.id);"></td>
				<td></td>
			...
			<tr>
				...
				<td></td>
				<td>
					<sx:datetimepicker  name="emp.hireDate" dayWidth="100%" id="hireDate" cssClass="mainContentsText"
					onclick="onFocusAction(this.id);"
					onkeydown="onFocusAction(this.id);"  value="" displayFormat="dd-MMM-yyyy"/>
					</td>
				<td></td>
				...
				<td></td>
				<td><sx:datetimepicker  name="emp.dob" dayWidth="100%" id="dob" cssClass="mainContentsText"
					 value="emp.dob" displayFormat="dd-MMM-yyyy"/>
			...
			<tr>
				...
				<td></td>
				<td>
					<s:select label="Gender"  list="{'Male','Female'}" name="emp.gender" cssClass="mainContentsText" value="emp.gender"/>
					</td>
				<td></td>
<!--				<td class="mainContentsText">Organisation <em><img-->
<!--					src="../images/required_star.gif"-->
<!--					alt="Default Number Format field is required" /></em></td>-->
				<td></td>
				<td>
					<s:select label="Organisation"  list="{'COLLEGE','SCHOOL'}" name="emp.organisation.organisationName" cssClass="mainContentsText" value="emp.organisation.organisationName"/>
...
<!--	Address Start		-->
	<tr class="middleline" >
	<td></td>
	<td colspan="8"><b>Address Type Permanent</b></td>
	</tr>
			<tr>
				<td></td>
				...
				<td><input class="mainContentsText" type="text" width="100%"
					value="" name="emp.address[0].addressType"
				...
				<td></td>
				<td><input class="mainContentsText" type="text" width="100%"
					value="" name="emp.address[0].addressOne"
			...
			<tr>
				...
				<td></td>
				<td><input class="mainContentsText" type="text" width="100%"
					value="" maxlength="" name="emp.address[0].street"
			...
			<tr>
				...
				<td></td>
				<td><input class="mainContentsText" type="text" width="100%"
					value="" maxlength="" name="emp.address[0].state"
					id="energysurcharge" tabindex="11"
					onclick="onFocusAction(this.id);"
					onkeydown="onFocusAction(this.id);"></td>
				<td></td>
				...
				<td></td>
				<td><input class="mainContentsText" type="text" width="100%"
					value="" name="emp.address[0].country"
					id="currenttocversion" tabindex="12"
					onclick="onFocusAction(this.id);"
					onkeydown="onFocusAction(this.id);"></td>
				<td></td>
