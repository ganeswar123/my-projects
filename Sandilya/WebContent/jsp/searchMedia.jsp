...
<h1><s:text name="welcome.title"/></h1>
 <table class="navigationBanner" width="100%" height="25px">
	<tr>
		<td width="100%">Library&nbsp;&nbsp;<img
			src="../images/menu/linkarrow.gif">Search Media&nbsp;(You are
		here)</td>
	</tr>
</table>
<table class="pageName" width="100%" bgcolor="#c9d7f1" height="25px">
	<tr>
		<td width="100%"><b>Search of Media</b></td>
	</tr>
</table>
<s:actionerror/>
<s:form   action="searchMediaAction" cssClass="sform" namespace="/jsp">
<div class='forminside'>
  <s:textfield name="type" label="Type" value="" />
  <s:textfield name="title" label="Title" value="" />
  <s:textfield name="author" label="Author" value="" />
  <s:textfield name="year" label="year" value="" />
